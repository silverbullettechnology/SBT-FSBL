 ...
 PARAMETER NAME = E:\hdl\hdl\projects\tdsdr_2chan\tdsdr\tdsdr_2chan_tdsdr.sdk\standalone_bsp_0\system.mss
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_ad9361_0_adc_dma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_ad9361_0_dac_dma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_ad9361_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_ad9361_1_adc_dma
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = axi_ad9361_1_dac_dma
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = axi_srio_initiator_fifo
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = llfifo
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = axi_srio_initiator_shadowfifo
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = llfifo
 PARAMETER DRIVER_VER = 4.0
 PARAMETER HW_INSTANCE = axi_srio_target_fifo
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = srio
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = srio_gen2_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER DRIVER_VER = 2.0
 PARAMETER HW_INSTANCE = sys_reg_0
END
